...
import com.HospitalManagementSytem.docklogin.repository.AppointmentsRepository;
...
public class AppointmentController {
	...
	public ResponseEntity<Map<String,Boolean>> deleteAppointment(@PathVariable long id) throws AttributeNotFoundException{
		...
		Appointments appointment = appointmentsRepository.findById(id).orElseThrow(()-> new AttributeNotFoundException("Appointment not found with id"+ id));
